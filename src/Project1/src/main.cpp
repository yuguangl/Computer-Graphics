...
int main()
{
    ...
    // Create window
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Water-Filled Glass Cube", NULL, NULL);
    if (window == NULL) {
    ...
    // Positions for the 3 inner cubes
    glm::vec3 cubePositions[] = {
        glm::vec3(-1.2f,  0.5f, -0.5f),
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        waterModel = glm::scale(waterModel, glm::vec3(2.8f));
        ...
        glassModel = glm::scale(glassModel, glm::vec3(3.0f));
