...
int main()
{
    ...
    float cubeVertices2[216] = { 0 };
    memcpy(cubeVertices2, cubeVertices, sizeof(cubeVertices));
    for(int i = 0; i < sizeof(cubeVertices) / sizeof(float); i++){
        if(abs(cubeVertices2[i]/0.5f) == 1.0f){
           cubeVertices2[i] = cubeVertices2[i] / 2.0f ;
        }
    }
    ...
    // cube VAO
    unsigned int cubeVAO, cubeVBO,cube2VAO,cube2VBO;
